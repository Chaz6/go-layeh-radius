...
type AlcDSLLineState uint32

var AlcDSLLineState_Strings = map[AlcDSLLineState]string{}

func (a AlcDSLLineState) String() string {
	if str, ok := AlcDSLLineState_Strings[a]; ok {
		return str
	}
	return "AlcDSLLineState(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcDSLLineState_Add(p *radius.Packet, value AlcDSLLineState) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 175, a)
}

func AlcDSLLineState_Get(p *radius.Packet) (value AlcDSLLineState) {
	value, _ = AlcDSLLineState_Lookup(p)
	return
}

func AlcDSLLineState_Gets(p *radius.Packet) (values []AlcDSLLineState, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 175) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcDSLLineState(i))
	}
	return
}

func AlcDSLLineState_Lookup(p *radius.Packet) (value AlcDSLLineState, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 175)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcDSLLineState(i)
	return
}

func AlcDSLLineState_Set(p *radius.Packet, value AlcDSLLineState) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 175, a)
}

func AlcDSLLineState_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 175)
}

type AlcDSLType uint32

var AlcDSLType_Strings = map[AlcDSLType]string{}

func (a AlcDSLType) String() string {
	if str, ok := AlcDSLType_Strings[a]; ok {
		return str
	}
	return "AlcDSLType(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcDSLType_Add(p *radius.Packet, value AlcDSLType) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 176, a)
}

func AlcDSLType_Get(p *radius.Packet) (value AlcDSLType) {
	value, _ = AlcDSLType_Lookup(p)
	return
}

func AlcDSLType_Gets(p *radius.Packet) (values []AlcDSLType, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 176) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcDSLType(i))
	}
	return
}

func AlcDSLType_Lookup(p *radius.Packet) (value AlcDSLType, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 176)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcDSLType_Set(p *radius.Packet, value AlcDSLType) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 176, a)
}

func AlcDSLType_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 176)
}
...
func AlcIpv6PortalURL_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 178, a)
}

func AlcIpv6PortalURL_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcIpv6PortalURL_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcIpv6PortalURL_Lookup(p)
	return
}

func AlcIpv6PortalURL_GetString(p *radius.Packet) (value string) {
	value, _ = AlcIpv6PortalURL_LookupString(p)
	return
}

func AlcIpv6PortalURL_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 178) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcIpv6PortalURL_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 178) {
		i = radius.String(attr)
		if err != nil {
...
func AlcIpv6PortalURL_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 178)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcIpv6PortalURL_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 178)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcIpv6PortalURL_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 178, a)
}

func AlcIpv6PortalURL_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcIpv6PortalURL_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 178)
}

type AlcSAPSessionIndex uint32

var AlcSAPSessionIndex_Strings = map[AlcSAPSessionIndex]string{}

func (a AlcSAPSessionIndex) String() string {
	if str, ok := AlcSAPSessionIndex_Strings[a]; ok {
		return str
	}
	return "AlcSAPSessionIndex(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcSAPSessionIndex_Add(p *radius.Packet, value AlcSAPSessionIndex) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 180, a)
}

func AlcSAPSessionIndex_Get(p *radius.Packet) (value AlcSAPSessionIndex) {
	value, _ = AlcSAPSessionIndex_Lookup(p)
	return
}

func AlcSAPSessionIndex_Gets(p *radius.Packet) (values []AlcSAPSessionIndex, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 180) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcSAPSessionIndex(i))
	}
	return
}

func AlcSAPSessionIndex_Lookup(p *radius.Packet) (value AlcSAPSessionIndex, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 180)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcSAPSessionIndex(i)
	return
}

func AlcSAPSessionIndex_Set(p *radius.Packet, value AlcSAPSessionIndex) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 180, a)
}

func AlcSAPSessionIndex_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 180)
}
...
type AlcWPPErrorCode uint32

var AlcWPPErrorCode_Strings = map[AlcWPPErrorCode]string{}

func (a AlcWPPErrorCode) String() string {
	if str, ok := AlcWPPErrorCode_Strings[a]; ok {
		return str
	}
	return "AlcWPPErrorCode(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcWPPErrorCode_Add(p *radius.Packet, value AlcWPPErrorCode) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 183, a)
}

func AlcWPPErrorCode_Get(p *radius.Packet) (value AlcWPPErrorCode) {
	value, _ = AlcWPPErrorCode_Lookup(p)
	return
}

func AlcWPPErrorCode_Gets(p *radius.Packet) (values []AlcWPPErrorCode, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 183) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcWPPErrorCode(i))
	}
	return
}

func AlcWPPErrorCode_Lookup(p *radius.Packet) (value AlcWPPErrorCode, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 183)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcWPPErrorCode(i)
	return
}

func AlcWPPErrorCode_Set(p *radius.Packet, value AlcWPPErrorCode) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 183, a)
}

func AlcWPPErrorCode_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 183)
}

func AlcOnetimeHTTPRedirectReactivate_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 185, a)
}

func AlcOnetimeHTTPRedirectReactivate_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcOnetimeHTTPRedirectReactivate_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcOnetimeHTTPRedirectReactivate_Lookup(p)
	return
}

func AlcOnetimeHTTPRedirectReactivate_GetString(p *radius.Packet) (value string) {
	value, _ = AlcOnetimeHTTPRedirectReactivate_LookupString(p)
	return
}

func AlcOnetimeHTTPRedirectReactivate_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 185) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcOnetimeHTTPRedirectReactivate_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 185) {
		i = radius.String(attr)
		if err != nil {
...
func AlcOnetimeHTTPRedirectReactivate_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 185)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcOnetimeHTTPRedirectReactivate_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 185)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcOnetimeHTTPRedirectReactivate_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 185, a)
}

func AlcOnetimeHTTPRedirectReactivate_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcOnetimeHTTPRedirectReactivate_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 185)
}

func AlcToServerDhcp6Options_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 191, a)
}

func AlcToServerDhcp6Options_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcToServerDhcp6Options_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcToServerDhcp6Options_Lookup(p)
	return
}

func AlcToServerDhcp6Options_GetString(p *radius.Packet) (value string) {
	value, _ = AlcToServerDhcp6Options_LookupString(p)
	return
}

func AlcToServerDhcp6Options_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 191) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcToServerDhcp6Options_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 191) {
		i = radius.String(attr)
		if err != nil {
...
func AlcToServerDhcp6Options_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 191)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcToServerDhcp6Options_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 191)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcToServerDhcp6Options_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 191, a)
}

func AlcToServerDhcp6Options_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcToServerDhcp6Options_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 191)
}

func AlcToClientDhcp6Options_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 192, a)
}

func AlcToClientDhcp6Options_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcToClientDhcp6Options_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcToClientDhcp6Options_Lookup(p)
	return
}

func AlcToClientDhcp6Options_GetString(p *radius.Packet) (value string) {
	value, _ = AlcToClientDhcp6Options_LookupString(p)
	return
}

func AlcToClientDhcp6Options_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 192) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcToClientDhcp6Options_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 192) {
		i = radius.String(attr)
		if err != nil {
...
func AlcToClientDhcp6Options_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 192)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcToClientDhcp6Options_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 192)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcToClientDhcp6Options_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 192, a)
}

func AlcToClientDhcp6Options_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcToClientDhcp6Options_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 192)
}

type AlcV6PreferredLifetime uint32

var AlcV6PreferredLifetime_Strings = map[AlcV6PreferredLifetime]string{}

func (a AlcV6PreferredLifetime) String() string {
	if str, ok := AlcV6PreferredLifetime_Strings[a]; ok {
		return str
	}
	return "AlcV6PreferredLifetime(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcV6PreferredLifetime_Add(p *radius.Packet, value AlcV6PreferredLifetime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 200, a)
}

func AlcV6PreferredLifetime_Get(p *radius.Packet) (value AlcV6PreferredLifetime) {
	value, _ = AlcV6PreferredLifetime_Lookup(p)
	return
}

func AlcV6PreferredLifetime_Gets(p *radius.Packet) (values []AlcV6PreferredLifetime, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 200) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcV6PreferredLifetime(i))
	}
	return
}

func AlcV6PreferredLifetime_Lookup(p *radius.Packet) (value AlcV6PreferredLifetime, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 200)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcV6PreferredLifetime(i)
	return
}

func AlcV6PreferredLifetime_Set(p *radius.Packet, value AlcV6PreferredLifetime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 200, a)
}

func AlcV6PreferredLifetime_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 200)
}

type AlcV6ValidLifetime uint32

var AlcV6ValidLifetime_Strings = map[AlcV6ValidLifetime]string{}

func (a AlcV6ValidLifetime) String() string {
	if str, ok := AlcV6ValidLifetime_Strings[a]; ok {
		return str
	}
	return "AlcV6ValidLifetime(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcV6ValidLifetime_Add(p *radius.Packet, value AlcV6ValidLifetime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 201, a)
}

func AlcV6ValidLifetime_Get(p *radius.Packet) (value AlcV6ValidLifetime) {
	value, _ = AlcV6ValidLifetime_Lookup(p)
	return
}

func AlcV6ValidLifetime_Gets(p *radius.Packet) (values []AlcV6ValidLifetime, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 201) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcV6ValidLifetime(i))
	}
	return
}

func AlcV6ValidLifetime_Lookup(p *radius.Packet) (value AlcV6ValidLifetime, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 201)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcV6ValidLifetime(i)
	return
}

func AlcV6ValidLifetime_Set(p *radius.Packet, value AlcV6ValidLifetime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 201, a)
}

func AlcV6ValidLifetime_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 201)
}

type AlcDhcp6RenewTime uint32

var AlcDhcp6RenewTime_Strings = map[AlcDhcp6RenewTime]string{}

func (a AlcDhcp6RenewTime) String() string {
	if str, ok := AlcDhcp6RenewTime_Strings[a]; ok {
		return str
	}
	return "AlcDhcp6RenewTime(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcDhcp6RenewTime_Add(p *radius.Packet, value AlcDhcp6RenewTime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 202, a)
}

func AlcDhcp6RenewTime_Get(p *radius.Packet) (value AlcDhcp6RenewTime) {
	value, _ = AlcDhcp6RenewTime_Lookup(p)
	return
}

func AlcDhcp6RenewTime_Gets(p *radius.Packet) (values []AlcDhcp6RenewTime, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 202) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcDhcp6RenewTime(i))
	}
	return
}

func AlcDhcp6RenewTime_Lookup(p *radius.Packet) (value AlcDhcp6RenewTime, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 202)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcDhcp6RenewTime(i)
	return
}

func AlcDhcp6RenewTime_Set(p *radius.Packet, value AlcDhcp6RenewTime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 202, a)
}

func AlcDhcp6RenewTime_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 202)
}

type AlcDhcp6RebindTime uint32

var AlcDhcp6RebindTime_Strings = map[AlcDhcp6RebindTime]string{}

func (a AlcDhcp6RebindTime) String() string {
	if str, ok := AlcDhcp6RebindTime_Strings[a]; ok {
		return str
	}
	return "AlcDhcp6RebindTime(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcDhcp6RebindTime_Add(p *radius.Packet, value AlcDhcp6RebindTime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_AddVendor(p, 203, a)
}

func AlcDhcp6RebindTime_Get(p *radius.Packet) (value AlcDhcp6RebindTime) {
	value, _ = AlcDhcp6RebindTime_Lookup(p)
	return
}

func AlcDhcp6RebindTime_Gets(p *radius.Packet) (values []AlcDhcp6RebindTime, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 203) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AlcDhcp6RebindTime(i))
	}
	return
}

func AlcDhcp6RebindTime_Lookup(p *radius.Packet) (value AlcDhcp6RebindTime, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 203)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcDhcp6RebindTime(i)
	return
}

func AlcDhcp6RebindTime_Set(p *radius.Packet, value AlcDhcp6RebindTime) (err error) {
	a := radius.NewInteger(uint32(value))
	return _AlcatelLucentServiceRouter_SetVendor(p, 203, a)
}

func AlcDhcp6RebindTime_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 203)
}
...
func AlcUPnPSubOverridePolicy_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 217, a)
}

func AlcUPnPSubOverridePolicy_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcUPnPSubOverridePolicy_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcUPnPSubOverridePolicy_Lookup(p)
	return
}

func AlcUPnPSubOverridePolicy_GetString(p *radius.Packet) (value string) {
	value, _ = AlcUPnPSubOverridePolicy_LookupString(p)
	return
}

func AlcUPnPSubOverridePolicy_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 217) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcUPnPSubOverridePolicy_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 217) {
		i = radius.String(attr)
		if err != nil {
...
func AlcUPnPSubOverridePolicy_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 217)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcUPnPSubOverridePolicy_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 217)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcUPnPSubOverridePolicy_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 217, a)
}

func AlcUPnPSubOverridePolicy_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcUPnPSubOverridePolicy_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 217)
}

func AlcTriggerAcctInterim_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 228, a)
}

func AlcTriggerAcctInterim_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcTriggerAcctInterim_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcTriggerAcctInterim_Lookup(p)
	return
}

func AlcTriggerAcctInterim_GetString(p *radius.Packet) (value string) {
	value, _ = AlcTriggerAcctInterim_LookupString(p)
	return
}

func AlcTriggerAcctInterim_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 228) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcTriggerAcctInterim_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 228) {
		i = radius.String(attr)
		if err != nil {
...
func AlcTriggerAcctInterim_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 228)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcTriggerAcctInterim_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 228)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcTriggerAcctInterim_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 228, a)
}

func AlcTriggerAcctInterim_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcTriggerAcctInterim_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 228)
}

type AlcAcctInterimLevel uint32

var AlcAcctInterimLevel_Strings = map[AlcAcctInterimLevel]string{}

func (a AlcAcctInterimLevel) String() string {
	if str, ok := AlcAcctInterimLevel_Strings[a]; ok {
		return str
	}
	return "AlcAcctInterimLevel(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AlcAcctInterimLevel_Add(p *radius.Packet, tag byte, value AlcAcctInterimLevel) (err error) {
	a := radius.NewInteger(uint32(value))
	if tag >= 0x01 && tag <= 0x1F {
		a[0] = tag
	} else {
	...
	return _AlcatelLucentServiceRouter_AddVendor(p, 232, a)
}

func AlcAcctInterimLevel_Get(p *radius.Packet) (tag byte, value AlcAcctInterimLevel) {
	tag, value, _ = AlcAcctInterimLevel_Lookup(p)
	return
}

func AlcAcctInterimLevel_Gets(p *radius.Packet) (tags []byte, values []AlcAcctInterimLevel, err error) {
	var i uint32
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 232) {
		var tag byte
		if len(attr) >= 1 && attr[0] <= 0x1F {
			tag = attr[0]
			attr[0] = 0x00
		...
		values = append(values, AlcAcctInterimLevel(i))
		tags = append(tags, tag)
	}
	return
}

func AlcAcctInterimLevel_Lookup(p *radius.Packet) (tag byte, value AlcAcctInterimLevel, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 232)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AlcAcctInterimLevel(i)
	return
}

func AlcAcctInterimLevel_Set(p *radius.Packet, tag byte, value AlcAcctInterimLevel) (err error) {
	a := radius.NewInteger(uint32(value))
	if tag >= 0x01 && tag <= 0x1F {
		a[0] = tag
	} else {
	...
	return _AlcatelLucentServiceRouter_SetVendor(p, 232, a)
}

func AlcAcctInterimLevel_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 232)
}

func AlcDNATOverride_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 234, a)
}

func AlcDNATOverride_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcDNATOverride_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcDNATOverride_Lookup(p)
	return
}

func AlcDNATOverride_GetString(p *radius.Packet) (value string) {
	value, _ = AlcDNATOverride_LookupString(p)
	return
}

func AlcDNATOverride_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 234) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcDNATOverride_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 234) {
		i = radius.String(attr)
		if err != nil {
...
func AlcDNATOverride_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 234)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcDNATOverride_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 234)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcDNATOverride_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 234, a)
}

func AlcDNATOverride_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcDNATOverride_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 234)
}

func AlcRemoveOverride_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 238, a)
}

func AlcRemoveOverride_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcRemoveOverride_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcRemoveOverride_Lookup(p)
	return
}

func AlcRemoveOverride_GetString(p *radius.Packet) (value string) {
	value, _ = AlcRemoveOverride_LookupString(p)
	return
}

func AlcRemoveOverride_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 238) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcRemoveOverride_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 238) {
		i = radius.String(attr)
		if err != nil {
...
func AlcRemoveOverride_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 238)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcRemoveOverride_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 238)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcRemoveOverride_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 238, a)
}

func AlcRemoveOverride_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcRemoveOverride_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 238)
}

func AlcRadiusPy_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 242, a)
}

func AlcRadiusPy_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcRadiusPy_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcRadiusPy_Lookup(p)
	return
}

func AlcRadiusPy_GetString(p *radius.Packet) (value string) {
	value, _ = AlcRadiusPy_LookupString(p)
	return
}

func AlcRadiusPy_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 242) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcRadiusPy_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 242) {
		i = radius.String(attr)
		if err != nil {
...
func AlcRadiusPy_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 242)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcRadiusPy_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 242)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcRadiusPy_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 242, a)
}

func AlcRadiusPy_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcRadiusPy_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 242)
}

func AlcForceDHCPRelay_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_AddVendor(p, 244, a)
}

func AlcForceDHCPRelay_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcForceDHCPRelay_Get(p *radius.Packet) (value []byte) {
	value, _ = AlcForceDHCPRelay_Lookup(p)
	return
}

func AlcForceDHCPRelay_GetString(p *radius.Packet) (value string) {
	value, _ = AlcForceDHCPRelay_LookupString(p)
	return
}

func AlcForceDHCPRelay_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 244) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AlcForceDHCPRelay_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _AlcatelLucentServiceRouter_GetsVendor(p, 244) {
		i = radius.String(attr)
		if err != nil {
...
func AlcForceDHCPRelay_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 244)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AlcForceDHCPRelay_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _AlcatelLucentServiceRouter_LookupVendor(p, 244)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AlcForceDHCPRelay_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _AlcatelLucentServiceRouter_SetVendor(p, 244, a)
}

func AlcForceDHCPRelay_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AlcForceDHCPRelay_Del(p *radius.Packet) {
	_AlcatelLucentServiceRouter_DelVendor(p, 244)
}
